...
exports.getCompanionState = getCompanionState;
const PHASE_PRESETS = {
    rampUp: {
...
function getCompanionState({ streak, sessionsCompleted, sessionsToday, currentPhase, evolutionTier, placement, preferredMode = 'image', }) {
    ...
    const calmness = clamp(0.42 + habitStrength * 0.24 + streakStrength * 0.22 + dailyCadence * 0.12, 0.38, 0.98);
    return {
        phase,
        breathingRange: [
