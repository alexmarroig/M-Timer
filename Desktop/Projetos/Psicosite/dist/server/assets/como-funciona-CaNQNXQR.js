...
import { L as Layout, P as PageHero, i as images, F as FinalContact } from "./Primitives-B9O0eYRr.js";
...
function ComoFuncionaPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-editorial grid gap-px bg-border md:grid-cols-2", children: steps.map(([title, text]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "bg-[var(--ivory)] p-8 md:p-10", children: [
