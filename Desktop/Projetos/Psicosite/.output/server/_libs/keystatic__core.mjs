...
const $empty = /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel");
function c(size) {
  ...
  block: {
    ...
    list: ({
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(List, {
        children: children.map((x, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", {
          children: x
        }, i))
      });
    },
    layout: ({
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        ...
        children: children.map((element, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          children: element
        }, i))
      });
    },
    table: ({
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", {
        children: [head && /* @__PURE__ */ jsxRuntimeExports.jsx("thead", {
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", {
            children: head.map((x, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", {
              colSpan: x.colSpan,
              rowSpan: x.rowSpan,
              children: x.children
            }, i))
          ...
          children: body.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", {
            children: row.map((x, j) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", {
              colSpan: x.colSpan,
              rowSpan: x.rowSpan,
              children: x.children
            }, j))
...
function DocumentNode(t0) {
  ...
  if ($[3] !== componentBlocks || $[4] !== renderers || $[5] !== node) {
    ...
    bb0: {
      ...
      if ($[8] !== componentBlocks || $[9] !== renderers) {
        t22 = (x, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(DocumentNode, {
          node: x,
          componentBlocks,
          renderers
        }, i);
      ...
      children = node.children.map(t22);
      bb1: switch (node.type) {
        case "blockquote": {
          t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.blockquote, {
            children
          });
          break bb0;
        }
        case "paragraph": {
          t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.paragraph, {
        ...
        case "code": {
          if (node.children.length === 1 && node.children[0] && typeof node.children[0].text === "string") {
            ...
            if ($[13] !== renderers.block.code || $[14] !== rest_0 || $[15] !== t3.text) {
              t4 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.code, {
                ...rest_0,
                children: t3.text
              });
        ...
        case "layout": {
          t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.layout, {
            layout: node.layout,
            children
          });
          break bb0;
        ...
        case "divider": {
          ...
          if ($[17] !== renderers.block.divider) {
            t3 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.divider, {});
        ...
        case "heading": {
          ...
          t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.heading, {
            ...rest,
            children
          });
          break bb0;
        ...
        case "component-block": {
          ...
          if (Comp) {
            ...
            let t3;
            if ($[21] !== Comp || $[22] !== props) {
              t3 = /* @__PURE__ */ jsxRuntimeExports.jsx(Comp, {
                ...props
              });
              $[21] = Comp;
              $[22] = props;
            ...
            if ($[24] !== renderers.block.block || $[25] !== t3) {
              t4 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.block, {
                children: t3
              });
        ...
        case "unordered-list": {
          ...
          if ($[27] !== renderers.block.list || $[28] !== children || $[29] !== t3) {
            t4 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.list, {
              children,
              type: t3
            });
        ...
        case "link": {
          ...
          if ($[31] !== renderers.inline.link || $[32] !== t3 || $[33] !== children) {
            t4 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.inline.link, {
              href: t3,
              children
            });
        ...
        case "image": {
          ...
          if ($[35] !== renderers.block.image || $[36] !== t3 || $[37] !== t4 || $[38] !== t5) {
            t6 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.image, {
              src: t3,
              alt: t4,
              title: t5
            });
        ...
        case "table": {
          ...
          const head = second ? first : void 0;
          let t3;
          if ($[40] !== head || $[41] !== componentBlocks || $[42] !== renderers) {
            t3 = head ? head.children[0].children.map((cell) => ({
              children: cell.children.map((x_0, i_0) => /* @__PURE__ */ jsxRuntimeExports.jsx(DocumentNode, {
                node: x_0,
                componentBlocks,
                renderers
              }, i_0))
          ...
          if ($[44] !== componentBlocks || $[45] !== renderers || $[46] !== t4) {
            ...
            if ($[48] !== componentBlocks || $[49] !== renderers) {
              t62 = (row) => row.children.map((cell_0) => ({
                children: cell_0.children.map((x_1, i_1) => /* @__PURE__ */ jsxRuntimeExports.jsx(DocumentNode, {
                  node: x_1,
                  componentBlocks,
                  renderers
                }, i_1))
          ...
          if ($[51] !== renderers.block.table || $[52] !== t3 || $[53] !== t5) {
            t6 = /* @__PURE__ */ jsxRuntimeExports.jsx(renderers.block.table, {
              head: t3,
              body: t5
            });
  ...
  let t2;
  if ($[55] !== children) {
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Fragment, {
      children
    });
    $[55] = children;
    $[56] = t2;
...
function DocumentRenderer(props) {
  ...
  if ($[9] !== componentBlocks || $[10] !== renderers || $[11] !== props.document) {
    ...
    if ($[13] !== componentBlocks || $[14] !== renderers) {
      t72 = (x, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(DocumentNode, {
        node: x,
        componentBlocks,
        renderers
      }, i);
  ...
  let t7;
  if ($[16] !== t6) {
    t7 = /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Fragment, {
      children: t6
    });
    $[16] = t6;
    $[17] = t7;
